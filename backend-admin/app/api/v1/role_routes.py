...
@router.get("/{role_id}", response_model=RoleResponse, responses={
    **common_errors,
    **not_found_error
})
...
@router.patch("/{role_id}", response_model=RoleResponse, responses={
    **common_errors,
    **not_found_error,
    **validation_error,
    **duplicate_entry_error
...
@router.delete("/{role_id}", status_code=status.HTTP_204_NO_CONTENT, responses={
    **common_errors,
    **not_found_error,
    **validation_error
})
