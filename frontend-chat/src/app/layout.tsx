    ...
    <html lang="en" suppressHydrationWarning className="h-full">
      ...
      >
        ...
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          <main className="relative flex flex-col md:justify-center items-center w-full h-full min-h-0 overflow-hidden md:p-1 sm:px-6 lg:px-8">
            ...
            <div className={cn(
              "relative z-10 w-full max-w-3xl md:rounded-2xl bg-white shadow-xl ring-1 ring-black/10 backdrop-blur dark:bg-black/30 dark:ring-white/10",
              "flex min-h-0",
              "mt-auto md:mt-8",
              "h-full md:h-auto md:min-h-[200px]"
            )}>
              {children}
            </div>
          </main>
