...
def store_docs_if_needed(docs_hash: str, docs: list[Document]):
    ...
    if not r.exists(key):
        ...
        r.set(key, json.dumps(doc_data, ensure_ascii=False), ex=60 * 60 * 24 * 7) 

def store_trace_entry(tenant_id: str, question: str, answer: str, docs_hash: str):
