...
import { UsePostCompanyUserResendInvite } from "@/hooks/api/lexobot-ai/company/UsePostCompanyUserResendInvite"
import { UseMutationCallbacks } from "@/hooks/UseMutationCallbacks"

export default function ActionsDropDown({ companyId, companyUserId, hasAccountCreated = false }: { companyId: number, companyUserId: number, hasAccountCreated: boolean }) {
    ...
    const { mutate: resendInvite } = UsePostCompanyUserResendInvite({
        companyId,
        companyUserId,
