...
from app.services.cache_engine import get_qa_cache_store, clean_cache_controlled
...
def get_similar_answer_or_none(tenant_id: str, question: str) -> str | None:
    try:
        ...
        if similar_docs:
            ...
            if are_questions_similar(tenant_id, question, cached_question):
...
def store_answer_if_needed(tenant_id: str, question: str, answer: str):
